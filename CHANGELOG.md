...
### Added
- Initial repo scaffolding: `docs/AGENTIC-WORKFLOW.md`, `docs/plans/ac-patterns.md`, project-local skills (`ac-verify`, `ui-verify`, `verify-workflow`, `release`), and enforcement hooks under `.claude/hooks/`.
